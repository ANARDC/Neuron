...
extension Date {
  var weekday: Int {
    (Calendar.current.component(.weekday, from: self) - 2) % 7 < 0 ? 7 + (Calendar.current.component(.weekday, from: self) - 2) % 7 : (Calendar.current.component(.weekday, from: self) - 2) % 7
  }
